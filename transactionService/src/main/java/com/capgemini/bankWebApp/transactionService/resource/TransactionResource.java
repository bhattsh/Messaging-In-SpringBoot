...
import com.capgemini.bankWebApp.transactionService.sender.Sender;
...
public class TransactionResource {
	...
	public ResponseEntity<Transaction> saveTransaction(@RequestBody Transaction transaction) {
		...
		if (transaction.getTransactionType().equalsIgnoreCase("deposit")) {
			transaction= transactionService.saveTransaction(transaction.getAccountNumber(), currentBalance,
